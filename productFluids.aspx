<%@ Page Title="" Language="C#" MasterPageFile="~/Citgo.master" AutoEventWireup="true" CodeFile="productFluids.aspx.cs" Inherits="productFluids" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">     <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <title>CITGO Lubricants | Engine Oil | Category Details</title>
    ...
    <div class="row">
            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_DEXRON-VI-ATF.png" title="TRANSGARD DEXRON -VI ATF" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD DEXRON -VI ATF<br /><br />
								
                                    </strong>
                                </p>
                        <a href="TRANSGARD_DEXRON-VI-ATF.aspx" class="button buttonblue">Details</a>
                    </div>
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_ATF_Plus4.png" title="TRANSGARD ATF+4" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD ATF+4<br /><br />
								
                                    </strong>
                                </p>
                        <a href="TRANSGARD_ATF_Plus4.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_Multi-Vehicle_High-Viscosity_ATF.png" title="TRANSGARD Multi-Vehicle High-Viscosity ATF" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD Multi-Vehicle High-Viscosity ATF<br /><br />
                                    </strong>
                                </p>
                        <a href="TRANSGARD_Multi-Vehicle_High-Viscosity_ATF.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_Multi-Vehicle_Low-Viscosity_ATF.png" title="TRANSGARD Multi-Vehicle Low-Viscosity ATF" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD Multi-Vehicle Low-Viscosity ATF<br /><br />
                                        
                                    </strong>
                                </p>
                        <a href="TRANSGARD_Multi-Vehicle_Low-Viscosity_ATF.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_CVT_Fluid.png" title="TRANSGARD CVT Fluid" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD CVT Fluid<br /><br />
								
                                    </strong>
                                </p>
                        <a href="TRANSGARD_CVT_Fluid.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_ATF_MERCON_V.png" title="TRANSGARD ATF, MERCON V" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD ATF, MERCON V<br /><br />
								
                                    </strong>
                                </p>
                        <a href="TRANSGARD_ATF_MERCON_V.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_Multi-Purpose_ATF.png" title="TRANSGARD Multi-Purpose ATF" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD Multi-Purpose ATF<br /><br />
                                        
                                    </strong>
                                </p>
                        <a href="TRANSGARD_Multi-Purpose_ATF.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/TRANSGARD_ATF_TypeF.png" title="TRANSGARD ATF Type F" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>TRANSGARD ATF Type F<br /><br />
								
                                    </strong>
                                </p>
                        <a href="TRANSGARD_ATF_TypeF.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/PowerSteeringFluid.png" title="Power Steering Fluid with Stop Leak" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>Power Steering Fluid with Stop Leak<br /><br />
								
                                    </strong>
                                </p>
                        <a href="PowerSteeringFluid.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />

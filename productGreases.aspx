<%@ Page Title="" Language="C#" MasterPageFile="~/Citgo.master" AutoEventWireup="true" CodeFile="productGreases.aspx.cs" Inherits="productGreases" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <title>CITGO Lubricants | Grease | Category Details</title>
    ...
    <div class="row">
            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/SynDurance_Premium_Synthetic_460_Grease_2.png" title="SynDurance Premium Synthetic 460 Grease No. 2" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>SynDurance Premium Synthetic 460 Grease No. 2<br /><br />
								
                                    </strong>
                                </p>
                        <a href="SYNDURANCE_PREMIUM_SYN_460_GREASE_NO_2.aspx" class="button buttonblue">Details</a>
                    </div>
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/CITGORedDrum.png" title="Lithoplex Red MP Grease" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>Lithoplex Red MP Grease<br /><br />
								
                                    </strong>
                                </p>
                        <a href="LITHOPLEX_RED_MP.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/Lithoplex_RT_Greases.png" title="Lithoplex RT Greases" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>Lithoplex RT Greases<br /><br />
								
                                    </strong>
                                </p>
                        <a href="LITHOPLEX_RT.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/CITGORedDrum.png" title="LITHOPLEX MP GREASES" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>LITHOPLEX MP GREASES<br /><br />
								
                                    </strong>
                                </p>
                        <a href="LITHOPLEX_MP.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/PREMIUM_LITHIUM_EP_GREASES.png" title="PREMIUM LITHIUM EP GREASES" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>PREMIUM LITHIUM EP GREASES<br/><br/></strong>
                                </p>
                        <a href="PREMIUM_LITHIUM_EP_GREASES.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />

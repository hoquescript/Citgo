<%@ Page Title="" Language="C#" MasterPageFile="~/Citgo.master" AutoEventWireup="true" CodeFile="CITGARD_SynDurance_Synthetic_Heavy_Duty_Engine_Oils.aspx.cs" Inherits="Engine_Oil_CITGARD_SynDurance_Synthetic_Heavy_Duty_Engine_Oils" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>CITGO Lubricants | CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils | Product Details</title>
</asp:Content>
...
<div class="containerFull clearfix">
	<div class="one-half2 taglineboximage"><img src="../../../images/header-image5.jpg" alt="" width="100%"/></div>
	<div class="one-half2 redbox">
		<h1 class="nopadding nomargin textcolor-white centered">DISCOVER THE CITGO DIFFERENCE</h1>
		LET US PROVE IT
	</div>
</div>
...
<div class="container">
	<div class="row clearfix">
		<div class="twelve columns breadcrumbs" style="text-transform: uppercase">
				...
				<a href="../../Welcome.html" id="crumb-welcome" class="crumb first">Welcome</a>
						...
						<a href="../../category/ENGINE_OIL.html" id="crumb-ENGINE_OIL" class="crumb">Engine Oil</a>
						
					
					<i class="fa fa-chevron-right" aria-hidden="true"></i>
					<span id="crumb-CITGARD_SYNDURANCE_PLUS_SYN_HD_EO" class="crumb last">CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils</span>
...
<!-- Start product.jsp -->
<div class="containerFull"  style="background: #f1f1f1;">
...
<!-- End inventoryDiscountSettings.jsp -->
				...
				<div id="product-CITGARD_SYNDURANCE_PLUS_SYN_HD_EO">
					
					
					
					<h2 class="textcolor-red">
						CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils
					</h2>
					...
					<br/>
						<i class="fa fa-file-text-o" aria-hidden="true"></i><strong> PI SHEETS</strong>
							...
							<tbody>
								<tr>
									...
									<td width="30%">
											...
											<a href="http://www.docs.citgo.com/msds_pi/C10234.pdf" target="_blank">
					...
					<i class="fa fa-file-text-o" aria-hidden="true"></i><strong> SD SHEETS</strong>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody>
									...
									<tr>
										<td width="70%">SAE 5W-30</td>
										<td width="30%">
											<a href="http://www.docs.citgo.com/msds_pi/622674001.pdf" target="_blank">English</a>
									...
									<tr>
										<td width="70%">SAE 5W-40</td>
										<td width="30%">
											<a href="http://www.docs.citgo.com/msds_pi/622672001.pdf" target="_blank">English</a>
					...
					<p id="addToCartForm">
						<form id="AddToCart" action="https://www.citgolubes.com/CartAdd.do" method="post">
...
<!-- Start attributesAndOptionsDefault.jsp -->
		...
		<input type="hidden" name="requiredAttributeCodes" value="CITGARD_SYNDURANCE_PLUS_SYN_HD_EO|CITGARD_SYNDURANCE_PLUS_SYN_HD_EO_PKG" />
		<input type="hidden" name="requiredAttributeNames" value="Packaging Size" />
		<input type="hidden" name="productNames" value="CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils" />
...
<!-- Start attribute-expanded.jsp -->

<div id="CITGARD_SYNDURANCE_PLUS_SYN_HD_EO-CITGARD_SYNDURANCE_PLUS_SYN_HD_EO_PKG" class="expanded attribute required">
	
	<p>
		<i class="fa fa-cube" aria-hidden="true"></i>&nbsp;<strong style="text-transform: uppercase;">Packaging Size</strong><br/>
...
<!-- End attribute-expanded.jsp -->
		...
		<input type="hidden" name="requiredAttributeCodes" value="CITGARD_SYNDURANCE_PLUS_SYN_HD_EO|CITGARD_SYNDURANCE_PLUS_SYN_HD_EO" />
		<input type="hidden" name="requiredAttributeNames" value="SAE 5W-30" />
		<input type="hidden" name="productNames" value="CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils" />
...
<!-- End attribute-expanded.jsp -->
		...
		<input type="hidden" name="requiredAttributeCodes" value="CITGARD_SYNDURANCE_PLUS_SYN_HD_EO|CITGARD_SYNDURANCE_PLUS_SYN_HD_EO" />
		<input type="hidden" name="requiredAttributeNames" value="SAE 5W-40" />
		<input type="hidden" name="productNames" value="CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils" />
...
<!-- End attributesAndOptions.jsp -->
			...
			<div class="six columns" style="text-align: center;">
					...
					<img src="assets/img/CITGARD_SynDurance_Synthetic_Heavy_Duty_Engine_Oils.png" title="CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils" alt="CITGARD SynDurance Plus Synthetic Heavy Duty Engine Oils"/>

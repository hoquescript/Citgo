<%@ Page Title="" Language="C#" MasterPageFile="~/Citgo.master" AutoEventWireup="true" CodeFile="productEngineOil.aspx.cs" Inherits="productEngineOil" %>
<%@ Register Src="ucEngineOil.ascx" TagPrefix="uc1" TagName="ucEngineOil" %>
    ...
    <div class="row">
            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/CITGARD_600_Multi-Viscosity_Engine_Oils.png" title="CITGARD 600 Multi-Viscosity Engine Oils" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>CITGARD 600 Multi-Viscosity Engine Oils<br /><br />
								
                                    </strong>
                                </p>
                        <a href="CITGARD_600_Multi-Viscosity_Engine_Oils.aspx" class="button buttonblue">Details</a>
                    </div>
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/CITGARD_700_Synthetic-Blend_EngineOils.png" title="CITGARD 700 Synthetic Blend Engine Oils" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>CITGARD 700 Synthetic Blend Engine Oils<br /><br />
								
                                    </strong>
                                </p>
                        <a href="CITGARD_700_Synthetic-Blend_EngineOils.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="images/CITGARD_SynDurance_Synthetic_Heavy_Duty_Engine_Oils.png" title="CITGARD SYNDURANCE PLUS SYNTHETIC HEAVY DUTY ENGINE OILS" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>CITGARD SYNDURANCE PLUS SYNTHETIC HEAVY DUTY ENGINE OILS<br /><br />
                                    </strong>
                                </p>
                        <a href="CITGARD_SynDurance_Synthetic_Heavy_Duty_Engine_Oils.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/SUPERGARD_UltraLife_Motor_Oils.png" title="SUPERGARD UltraLife Motor Oils" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>SUPERGARD UltraLife Motor Oils<br /><br />
                                        
                                    </strong>
                                </p>
                        <a href="SUPERGARD_UltraLife_Motor_Oils.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/Supergard_EuropeanFormula_MotorOil.png" title="SUPERGARD EUROPEAN FORMULA MOTOR OIL" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>SUPERGARD EUROPEAN FORMULA MOTOR OIL<br /><br />
								
                                    </strong>
                                </p>
                        <a href="Supergard_EuropeanFormula_MotorOil.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                                <img src="assets/img/SUPERGARD_Synthetic_Blend_10W40.png" title="SUPERGARD SYNTHETIC BLEND SAE 10W-40" alt="Image for product CITGARD_700_SYNBLEND_EO" class="scale-with-grid">
                                <p class="productTitle">
                                    <strong>SUPERGARD SYNTHETIC BLEND SAE 10W-40<br /><br />
								
                                    </strong>
                                </p>
                        <a href="SUPERGARD_Synthetic_Blend_10W40.aspx" class="button buttonblue">Details</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="images/logosmall.png" />
